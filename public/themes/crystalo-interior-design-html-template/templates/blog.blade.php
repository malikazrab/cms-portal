...
<head>
    <meta charset="UTF-8">
    <title>Blog Default || Crystalo || Responsive HTML 5 Template</title>
                        ...
                        <div class="single-blog-colum-style1">
                            ...
                            <div class="single-blog-post style3 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                ...
                                <div class="text-holder">
                                    <h3 class="blog-title"><a href="blog-single.html">Best low-cost interior designing ideas for your room</a></h3>
                                    <div class="meta-box">
                                        <ul class="meta-info">
                                    ...
                                    <div class="text">
                                        ...
                                        <a class="btn-two" href="blog-single.html">Read More<span class="flaticon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-blog-colum-style1">
                            ...
                            <div class="single-blog-post style3 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                                ...
                                <div class="text-holder">
                                    <h3 class="blog-title"><a href="blog-single.html">Wondering if interior design is a dying filed? Read this</a></h3>
                                    <div class="meta-box">
                                        <ul class="meta-info">
                                            <li>By <a href="#">Mark Wood</a></li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-blog-colum-style1">
                            ...
                            <div class="single-blog-post style3 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                                ...
                                <div class="text-holder">
                                    <h3 class="blog-title"><a href="blog-single.html">Creating drama and feeling with a tiled bed wall</a></h3>
                                    <div class="meta-box">
                                        <ul class="meta-info">
                                            <li>By <a href="#">Rubin Santro</a></li>
                                            <li>In <a href="#">Traditional</a></li>
