...
// routes/web.php
Route::prefix('admin')->name('admin.')->middleware(['web', 'activity', 'permission:users.manage'])->group(function () {
...
Route::middleware(['auth', 'admin.auth'])
    ...
    ->group(function () {
        ...
        Route::get('headers', [HeaderTemplateController::class, 'index'])->middleware('permission:headers.manage')->name('headers.index');
        Route::get('headers/create', [HeaderTemplateController::class, 'create'])->middleware('permission:headers.manage')->name('headers.create');
        Route::post('headers', [HeaderTemplateController::class, 'store'])->middleware('permission:headers.manage')->name('headers.store');
        Route::get('headers/{headerTemplate}/edit', [HeaderTemplateController::class, 'edit'])->middleware('permission:headers.manage')->name('headers.edit');
        Route::put('headers/{headerTemplate}', [HeaderTemplateController::class, 'update'])->middleware('permission:headers.manage')->name('headers.update');
        Route::delete('headers/{headerTemplate}', [HeaderTemplateController::class, 'destroy'])->middleware('permission:headers.manage')->name('headers.destroy');
        Route::post('headers/{headerTemplate}/set-default', [HeaderTemplateController::class, 'setDefault'])->middleware('permission:headers.manage')->name('headers.set-default');

        Route::get('footers', [FooterTemplateController::class, 'index'])->middleware('permission:footers.manage')->name('footers.index');
        Route::get('footers/create', [FooterTemplateController::class, 'create'])->middleware('permission:footers.manage')->name('footers.create');
        Route::post('footers', [FooterTemplateController::class, 'store'])->middleware('permission:footers.manage')->name('footers.store');
        Route::get('footers/{footerTemplate}/edit', [FooterTemplateController::class, 'edit'])->middleware('permission:footers.manage')->name('footers.edit');
        Route::put('footers/{footerTemplate}', [FooterTemplateController::class, 'update'])->middleware('permission:footers.manage')->name('footers.update');
        Route::delete('footers/{footerTemplate}', [FooterTemplateController::class, 'destroy'])->middleware('permission:footers.manage')->name('footers.destroy');
        Route::post('footers/{footerTemplate}/set-default', [FooterTemplateController::class, 'setDefault'])->middleware('permission:footers.manage')->name('footers.set-default');
        ...
        Route::get('/menus/create', [MenuController::class, 'create'])->middleware('permission:menus.manage')->name('menus.create');
        Route::post('/menus', [MenuController::class, 'store'])->middleware('permission:menus.manage')->name('menus.store');
        Route::get('/menus/{menu}/edit', [MenuController::class, 'edit'])->middleware('permission:menus.manage')->name('menus.edit');
        Route::put('/menus/{menu}', [MenuController::class, 'update'])->middleware('permission:menus.manage')->name('menus.update');
        Route::delete('/menus/{menu}', [MenuController::class, 'destroy'])->middleware('permission:menus.manage')->name('menus.destroy');
        Route::post('/menus/{menu}/set-default', [MenuController::class, 'setDefault'])->middleware('permission:menus.manage')->name('menus.set-default');
