    ...
    <div class="rounded bg-white p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-gray-600">Manage reusable header templates for your website.</p>
            </div>
        ...
        <div class="divide-y divide-gray-200">
            @forelse ($templates as $template)
                <div class="p-6 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <form action="{{ route('admin.headers.set-default', $template) }}" method="POST" class="inline-flex items-center gap-2">
                                @csrf
                            ...
                            <a href="{{ route('admin.headers.edit', $template) }}" class="rounded px-3 py-2 text-sm text-blue-600 hover:bg-blue-50">
                                Edit
                            </a>
                            <form action="{{ route('admin.headers.destroy', $template) }}" method="POST" class="inline" onsubmit="return confirm('Delete this header template?');">
                                @csrf
                                @method('DELETE')
            ...
            @empty
                <div class="p-12 text-center">
                    <p class="text-gray-500">No headers created yet.</p>
                    <a href="{{ route('admin.headers.create') }}" class="mt-3 inline-block text-sm text-blue-600 hover:text-blue-700">
